...
TEMPLATE_CMD=$TEMPLATE_CMD" $job interop-eks-cronjob-chart/interop-eks-cronjob-chart -f commons/$ENV/values-cronjob.compiled.yaml -f jobs/$job/$ENV/values.yaml $OUTPUT_TO"
