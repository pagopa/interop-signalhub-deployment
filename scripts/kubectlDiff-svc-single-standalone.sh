...
HELM_TEMPLATE_CMD="./helmTemplate-svc-single.sh -e $ENV -m $microservice $OPTIONS"
DIFF_CMD="KUBECTL_EXTERNAL_DIFF=./diff.sh kubectl diff --show-managed-fields=false -f -"
